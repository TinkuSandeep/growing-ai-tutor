...
def generate_question(subject: str, topic: str, difficulty: int = 1) -> dict:
    ...
    science = {
        "Plants": [
            ("Which part of a plant usually takes in water from the soil?", "roots"),
            ("What do most green plants need from the Sun to make food?", "sunlight"),
            ("Which part of a plant usually holds it upright?", "stem"),
        ],
        "Animals": [
            ("Which animal is a mammal: frog, butterfly, cow, or fish?", "cow"),
            ("What do we call animals that eat only plants?", "herbivores"),
            ("Which body covering does a bird have: fur, feathers, or scales?", "feathers"),
        ],
        "Our Body": [
            ("Which organ helps us breathe?", "lungs"),
            ("Which organ pumps blood around the body?", "heart"),
            ("Which sense organ do we use to see?", "eyes"),
        ],
    }
    if subject == "Science" and topic in science:
        question, answer = random.choice(science[topic])
        return _q(subject, topic, question, answer, difficulty)
